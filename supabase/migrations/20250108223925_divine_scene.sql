/*
  ...
  1. New Users
    ...
    - One user (Eleanor) automatically likes all other users
  
  2. Changes
    - Add trigger for Eleanor to automatically like new users
    - Update RLS policies to allow system-generated likes
*/
...
BEGIN
  ...
  -- Make Eleanor like everyone
  INSERT INTO likes (from_user_id, to_user_id)
  VALUES
    (eleanor_id, charles_id),
    (eleanor_id, beatrice_id);
